export function BackgroundDecor() {
  ...
  const images = [
    ...
    // Row 4
    { src: "/images/trees.png", top: "50%", left: "20%", size: 140, rotate: -3, opacity: 0.45 },
    ...
    { src: "/images/trees.png", top: "53%", left: "72%", size: 140, rotate: 12, opacity: 0.45 },
    // Row 6 - bottom
    ...
    { src: "/images/wineglasses.png", top: "88%", left: "88%", size: 130, rotate: 5, opacity: 0.55 },
